...
public class FragmentTabHost extends LinearLayout {
	...
	static class CtripTabSavedState extends BaseSavedState {
		...
		public static final Parcelable.Creator<CtripTabSavedState> CREATOR = new Parcelable.Creator<CtripTabSavedState>() {
	...
	public void replaceTab(String tag, Fragment fragment) {
		FragmentTransaction ft = mFragmentManager.beginTransaction();

		// yiqi注:直接使用FragmentTransaction.replace会产生fragment错乱问题，所以改用detach->add
		...
		ft.add(R.id.tab_host_continar, fragment, tag);
